		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body" style="padding-top: 30px;">
				<header id="cabecera" class="page-header animated fadeInLeft">
					...
					<h2>Mantenimiento de Tipo Imagen</h2>
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							<li><a href="#"> <i class="fa fa-home"></i>
							</a></li>
							<li><span>Mantenimiento de Tipo Imagen</span></li>
						</ol>
					...
					<div class="col-md-12">
						<section class="panel animated fadeInRight">
							<header class="panel-heading">
								<h2 class="panel-title">LISTA DE TIPOS DE IMAGEN</h2>
							</header>

							<div class="panel-body">
								<div id="tabla">
									<table id="tblTipoImagen"
...
<!-- 										<a id="btnEliminar" class="btn btn-sm btn-primary width-default" onclick="preguntar();"><i class="fa fa-times"></i> ELIMINAR</a> -->
					...
					<div class="col-md-12" id="divTipoImagen" style="display: none">
						<form method="post" class="form-horizontal"  id="form" name="form">
							<input type="hidden" name="method" value="" /> 

							<section class="panel animated fadeInRight">
								<header class="panel-heading">
									<h2 class="panel-title">DATOS DEL TIPO IMAGEN</h2>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label"> TIPO DE IMAGEN <span class="required">*</span>
										</label>
										<div class="col-sm-9">
...
<%-- 		<jsp:include page="plantillas/sidebar.jsp" /> --%>
	...
	function inicializarVariables(){
		var tableTest= $('#tblTipoImagen').DataTable();
		document.getElementById("divTipoImagen").style.display = "none";
	}
	
	function cargarComponentes(){
		$.ajax({
			url : "./cargarComponentesTipoImagen",
			type : "POST",
			dataType : "json"
		})
		.done(
			function(paramJson) {
				...
				if (paramJson.estadoRespuesta == 'OK') {
					...
					loadTableDocumento(lstTipoImagen);
			...
			.done(
				function(paramJson) {
					...
					if (paramJson.estadoRespuesta == 'OK') {
						...
						limpiarText();
						callNotification('success','Se ha guardado satisfactoriamente los datos del tipoImagen','Correcto');
						document.getElementById("divTipoImagen").style.display = "none";
						var lstTipoImagen = JSON.parse(paramJson.parametros.lstTipoImagen);
						loadTableDocumento(lstTipoImagen);
					} else {
	...
	function loadTableDocumento(lista){
		 ...
		 $('#tblTipoImagen').dataTable().fnClearTable();
		 var tblTipoImagen = $('#tblTipoImagen').DataTable(); 
		...
		if(lista.length > 0){
		 ...
		 $.each(lista,function(i,obj){
			 ...
			 var rowNode = tblTipoImagen.row.add( [
		...
		// Centrando columnas seleccion y codigo
		$('#tblTipoImagen').find('tr').each(function() {
	...
	function nuevo() {
		...
		.done(
			function(paramJson) {
				if (paramJson.estadoRespuesta == 'OK') {
					document.getElementById("divTipoImagen").style.display = "inline";
